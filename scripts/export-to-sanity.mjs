...
const projectId = process.env.PUBLIC_SANITY_PROJECT_ID || 'kfijnkqa';
const dataset = process.env.PUBLIC_SANITY_DATASET || 'production';
const apiVersion = process.env.PUBLIC_SANITY_API_VERSION || '2026-09-21';
...
export const documents = [
  ...
  // 3. Categorías
  {
    ...
    _type: 'categoria',
    nombre: 'Flores',
    slug: { _type: 'slug', current: 'flores' },
    descripcion: 'Ramos frescos, flores cortadas y arreglos de temporada preparados a pedido.',
    icono: 'flower',
    orden: 1,
  },
  {
    ...
    _type: 'categoria',
    nombre: 'Plantas',
    slug: { _type: 'slug', current: 'plantas' },
    descripcion: 'Plantas de interior y exterior adaptadas al clima del sur de Chile.',
    icono: 'leaf',
    orden: 2,
  },
  {
    _id: 'cat-macetas',
    _type: 'categoria',
    nombre: 'Macetas y jardín',
    slug: { _type: 'slug', current: 'macetas-y-jardin' },
    descripcion: 'Macetas de greda, barro cocido, platos de drenaje y sustratos premium.',
    icono: 'pot',
    orden: 3,
  },
  {
    _id: 'cat-herramientas',
    _type: 'categoria',
    nombre: 'Herramientas',
    slug: { _type: 'slug', current: 'herramientas' },
    descripcion: 'Tijeras de poda en acero inoxidable, palas de mano y pulverizadores.',
    icono: 'tools',
    orden: 4,
  },
  ...
  // 4. Productos
  {
    ...
    slug: { _type: 'slug', current: 'ramo-de-peonias-rosadas' },
    precio: 14990,
    unidad: 'por ramo',
    etiqueta: 'Flores',
    categoria: {
    ...
    cuidados:
      'Mantener en agua fresca, cortar los tallos 1 cm en diagonal cada dos días y ubicar lejos del sol directo.',
    destacado: true,
    disponible: true,
  },
  {
    ...
    slug: { _type: 'slug', current: 'monstera-deliciosa-maceta-20cm' },
    precio: 22990,
    ...
    cuidados:
      'Riego moderado (cuando el sustrato superior esté seco), luz indirecta brillante y pulverizar hojas en verano.',
    destacado: true,
    disponible: true,
  },
  {
    ...
    slug: { _type: 'slug', current: 'maceta-de-barro-artesanal-n3' },
    precio: 7990,
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'set-de-poda-de-3-piezas' },
    precio: 18990,
    unidad: 'kit de 3 herramientas',
    etiqueta: 'Herramientas',
    categoria: {
      _type: 'reference',
      _ref: 'cat-herramientas',
    },
    descripcion:
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'arreglo-de-girasoles' },
    precio: 13490,
    unidad: 'por arreglo',
    etiqueta: 'Flores',
    categoria: {
  ...
  },
  {
    ...
    slug: { _type: 'slug', current: 'sustrato-premium-5kg' },
    precio: 6490,
    unidad: 'saco 5 kg',
    etiqueta: 'Jardín',
    categoria: {
    ...
    contenido: [
      {
        ...
        _type: 'block',
        style: 'h3',
        children: [{ _key: 's1-1', _type: 'span', text: 'Preparando el entorno para el clima del sur', marks: [] }],
        markDefs: [],
      },
      {
        _key: 'p1-1',
        ...
        children: [
          {
            _key: 's1-2',
            _type: 'span',
            text: 'En el sur de Chile y sus alrededores, las variaciones de humedad, viento y precipitaciones marcan los ciclos de la vegetación. Es fundamental elegir plantas adaptadas a suelos ricos en materia orgánica y proteger las especies más sensibles durante los cambios bruscos de temperatura.',
            marks: [],
          },
        ],
        markDefs: [],
      },
      {
        ...
        _type: 'block',
        style: 'h3',
        children: [{ _key: 's1-3', _type: 'span', text: 'El secreto de un sustrato saludable', marks: [] }],
        markDefs: [],
      },
      {
        _key: 'p1-2',
        ...
        children: [
          {
            _key: 's1-4',
            _type: 'span',
            text: 'Un buen drenaje es clave para evitar encharcamientos. La combinación de tierra de hojas, perlita y abono orgánico proporciona la oxigenación necesaria para que las raíces se desarrollen sin asfixia, tanto en canteros exteriores como en macetas de interior.',
            marks: [],
          },
        ],
        markDefs: [],
      },
      {
        ...
        _type: 'block',
        style: 'h3',
        children: [{ _key: 's1-5', _type: 'span', text: 'Riego y luminosidad', marks: [] }],
        markDefs: [],
      },
      {
        _key: 'p1-3',
        ...
        children: [
          {
            _key: 's1-6',
            _type: 'span',
            text: 'Durante los meses de primavera y verano, es conveniente regar a primera hora de la mañana o al atardecer para evitar la evaporación inmediata. En interiores, ubicar las plantas cerca de ventanas con luz difusa favorece una floración prolongada y hojas de verde intenso.',
            marks: [],
          },
        ],
        markDefs: [],
    ...
    contenido: [
      {
        ...
        _type: 'block',
        style: 'h3',
        children: [{ _key: 's2-1', _type: 'span', text: 'Corte diagonal de los tallos', marks: [] }],
        markDefs: [],
      },
      {
        _key: 'p2-1',
        ...
        children: [
          {
            _key: 's2-2',
            _type: 'span',
            text: 'Al recibir tu ramo, corta aproximadamente 1 a 2 cm de cada tallo en un ángulo de 45 grados bajo agua tibia o corriente. Esto evita que entren burbujas de aire en los vasos conductores y maximiza la absorción de agua.',
            marks: [],
          },
        ],
        markDefs: [],
      },
      {
        ...
        _type: 'block',
        style: 'h3',
        children: [{ _key: 's2-3', _type: 'span', text: 'Agua limpia y florero desinfectado', marks: [] }],
        markDefs: [],
      },
      {
        _key: 'p2-2',
        ...
        children: [
          {
            _key: 's2-4',
            _type: 'span',
            text: 'Cambia el agua cada 48 horas y asegúrate de retirar cualquier hoja que quede sumergida, ya que las hojas bajo el agua generan bacterias que descomponen los tallos rápidamente.',
            marks: [],
          },
        ],
        markDefs: [],
    ...
    contenido: [
      {
        ...
        _type: 'block',
        style: 'h3',
        children: [{ _key: 's3-1', _type: 'span', text: 'Barro cocido vs. Plástico: ¿cuál elegir?', marks: [] }],
        markDefs: [],
      },
      {
        _key: 'p3-1',
        ...
        children: [
          {
            _key: 's3-2',
            _type: 'span',
            text: 'Las macetas de greda y barro cocido son porosas, lo que permite que la tierra respire y el exceso de humedad se evapore por las paredes. Son ideales para plantas que no toleran encharcamiento como suculentas, romeros y monsteras. Las de plástico retienen más agua, siendo útiles para helechos o plantas de sotobosque.',
            marks: [],
          },
        ],
        markDefs: [],
      },
      {
        ...
        _type: 'block',
        style: 'h3',
        children: [{ _key: 's3-3', _type: 'span', text: 'La regla del orificio de drenaje', marks: [] }],
        markDefs: [],
      },
      {
        _key: 'p3-2',
        ...
        children: [
          {
            _key: 's3-4',
            _type: 'span',
            text: 'Nunca plantes directamente en recipientes sin orificio de salida de agua. Si deseas usar un macetero decorativo cerrado, úsalo como cubre-maceta y coloca adentro una maceta con drenaje sobre un lecho de piedras o arcilla expandida.',
            marks: [],
          },
        ],
        markDefs: [],
...
const ndjsonPath = path.join(dataDir, 'sanity-export.ndjson');
const ndjsonContent = documents.map((doc) => JSON.stringify(doc)).join('\n') + '\n';
fs.writeFileSync(ndjsonPath, ndjsonContent, 'utf8');
console.log(`✅ Archivo NDJSON generado en: ${ndjsonPath} (${documents.length} documentos)`);

/* ==========================================================================
   Subir a Sanity directamente si hay token disponible
   ========================================================================== */

async function main() {
  if (!token) {
    console.log('\n⚠️  No se encontró SANITY_API_TOKEN o SANITY_AUTH_TOKEN en el entorno.');
    console.log(`ℹ️  Puedes importar los datos usando una de las siguientes opciones:`);
    console.log(`\n  Opción 1 (Vía Sanity CLI):`);
    console.log(`    npx sanity dataset import data/sanity-export.ndjson ${dataset} --replace`);
    console.log(`\n  Opción 2 (Con un token de API de Sanity con rol Editor o Admin):`);
    console.log(`    SANITY_API_TOKEN="tu_token" node scripts/export-to-sanity.mjs\n`);
    return;
  }

  console.log(`\n🚀 Conectando a Sanity (Project: ${projectId}, Dataset: ${dataset})...`);
  ...
  for (const doc of documents) {
    try {
      ...
      console.log(`  ✓ [${doc._type}] ${doc._id} (${doc.nombre || doc.titulo || doc._id})`);
    } catch (err) {
